...
const RAW = [
  ...
  // NOTE: the Exclusive (Executive) plan no longer uses these general tasks — its task
  // system is mathematics-only (see the maths catalog in server.js / mathtasks.js).
];
